...
class SearchableData {
	...
	static let bjEmbassies = 0
	static let cnProvinces = 1
	static let itProvinces = 2
	static let deEmbassies = 3
	static let kfzOffices  = 4
	static let chCantons   = 5
	static let frDepts	   = 6

	class func searchItems(_ searchSpace: Int) -> [String] {
		switch (searchSpace) {
